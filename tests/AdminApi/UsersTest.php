...
EOD;
        ...
        $this->assertEquals('/admin/v1/users', $tr->request->path);
    }
...
EOD;
        ...
        $this->assertNotNull($res);
        $this->assertEquals('GET', $tr->request->method);
        $this->assertEquals('/admin/v1/users/userId', $tr->request->path);
    }
...
EOD;
        ...
        $this->assertNotNull($res);
        $this->assertEquals('POST', $tr->request->method);
        $this->assertEquals('/admin/v1/users/userId:undelete', $tr->request->path);
    }
...
EOD;
        ...
        $this->assertNotNull($res);
        $this->assertEquals('POST', $tr->request->method);
        $this->assertEquals('/admin/v1/users/userId:connect', $tr->request->path);
    }
...
EOD;
        ...
        $this->assertNotNull($res);
        $this->assertEquals('POST', $tr->request->method);
        $this->assertEquals('/admin/v1/users/userId:disconnect', $tr->request->path);
    }
...
EOD;
        ...
        $this->assertNotNull($res);
        $this->assertEquals('POST', $tr->request->method);
        $this->assertEquals('/admin/v1/users/userId:import', $tr->request->path);
    }
...
EOD;
        ...
        $this->assertNotNull($res);
        $this->assertEquals('POST', $tr->request->method);
        $this->assertEquals('/admin/v1/users/userId:createApiSession', $tr->request->path);
    }
...
EOD;
        ...
        $this->assertNotNull($res);
        $this->assertEquals('POST', $tr->request->method);
        $this->assertEquals('/admin/v1/users/userId:createPortalSession', $tr->request->path);
    }
}
